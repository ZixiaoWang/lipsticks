...
var LIPSTICKS = [{
  ...
  "brand": "Givenchy",
  "colour": "N°301-Vermillon Création",
  "r": 207,
  "g": 37,
  "b": 43,
  "rgb": "rgb(207, 37, 43)",
  ...
  "brand": "Givenchy",
  "colour": "N°303-Framboise Griffée",
  "r": 194,
  "g": 144,
  "b": 126,
  "rgb": "rgb(194, 144, 126)",
  ...
  "brand": "Pat McGrath Labs",
  "colour": "Celestial Divinity Pavé Omi (Mid-tone Rose)NEW",
  "r": 136,
  "g": 53,
  "b": 53,
  "rgb": "rgb(136, 53, 53)",
  ...
  "brand": "Pat McGrath Labs",
  "colour": "Celestial Divinity Pavé Elson (Blue Red)NEW",
  "r": 122,
  "g": 10,
  "b": 21,
  "rgb": "rgb(122, 10, 21)",
...
var ColorsMatrix = function ColorsMatrix() {
  ...
  return (0, _preact.h)(_preact.Fragment, null, (0, _preact.h)("div", {
    className: "matrix",
    id: "matrix"
  }, _lipsticksService.SORTED_LIPSTICKS.map(item)), (0, _preact.h)("header", {
    className: "header"
...
var Home = function Home() {
  ...
  return (0, _preact.h)(_preact.Fragment, null, (0, _preact.h)("div", {
    className: "home"
  }, (0, _preact.h)("p", null, (0, _preact.h)("span", null, "\u563F\u670B\u53CB")), (0, _preact.h)("p", null, (0, _preact.h)("span", null, "\u4F60\u662F\u5426\u9047\u5230\u4E86\u4F20\u8BF4\u4E2D\u7684"), " ", (0, _preact.h)("br", null), (0, _preact.h)("span", {
    className: "red"
    ...
    className: "small"
  }, "BY"), (0, _preact.h)("span", null, "\u54C1\u724C")), (0, _preact.h)("button", {
    onClick: gotoColors
  }, (0, _preact.h)("span", {
    className: "small"
...
},{"./brands":"pages/brands.jsx","./colors":"pages/colors.jsx","./home":"pages/home.jsx","./lipstick":"pages/lipstick.jsx"}],"../node_modules/@babel/runtime/helpers/esm/extends.js":[function(require,module,exports) {
"use strict";
...
var m,
    x = m || (exports.Action = m = {});
exports.Action = m;
x.Pop = "POP";
x.Push = "PUSH";
x.Replace = "REPLACE";
var y = "production" !== "development" ? function (a) {
...
function createBrowserHistory(a) {
  ...
  function t(a, d) {
    void 0 === d && (d = null);
    return y((0, _extends2.default)({}, l, {}, "string" === typeof a ? F(a) : a, {
      state: d,
      key: D()
    }));
  }
  ...
  h.addEventListener("popstate", function () {
    if (p) e.call(p), p = null;else {
      ...
      if (e.length) {
        ...
        } else "production" !== "development" ? z(!1, "You are trying to block a POP navigation to a location that was not created by the history library. The block will fail silently in production, but in general you should do all navigation with the history library (instead of using window.history.pushState directly) to avoid this situation.") : void 0;
      } else v(a);
    }
  });
  var n = m.Pop;
  ...
  var q = a[0],
      ...
      c = B(),
      e = B();
  null == q && (q = 0, f.replaceState((0, _extends2.default)({}, f.state, {
    idx: q
  }), ""));
  return {
    get action() {
...
function createHashHistory(a) {
  ...
  function v(a, b) {
    void 0 === b && (b = null);
    return y((0, _extends2.default)({}, c, {}, "string" === typeof a ? F(a) : a, {
      state: b,
      key: D()
    }));
  }
  ...
  function u(a, c) {
    ...
    var b = m.Push,
        e = v(a, c);
    "production" !== "development" ? z("/" === e.pathname.charAt(0), "Relative pathnames are not supported in hash history.push(" + JSON.stringify(a) + ")") : void 0;
  ...
  function r(a, c) {
    ...
    var e = m.Replace,
        b = v(a, c);
    "production" !== "development" ? z("/" === b.pathname.charAt(0), "Relative pathnames are not supported in hash history.replace(" + JSON.stringify(a) + ")") : void 0;
    k.length && (k.call({
      action: e,
      location: b,
      retry: d
  ...
  var l = a[0],
      ...
      e = B(),
      k = B();
  null == l && (l = 0, p.replaceState((0, _extends2.default)({}, p.state, {
    idx: l
  }), ""));
  return {
    get action() {
...
function createMemoryHistory(a) {
  function b(a, b) {
    void 0 === b && (b = null);
    return y((0, _extends2.default)({}, n, {}, "string" === typeof a ? F(a) : a, {
      state: b,
      key: D()
    }));
  }
  ...
  function v(a, e) {
    var c = m.Push,
        d = b(a, e);
    "production" !== "development" ? z("/" === n.pathname.charAt(0), "Relative pathnames are not supported in memory history.push(" + JSON.stringify(a) + ")") : void 0;
    g(c, d, function () {
      v(a, e);
  ...
  function w(a, e) {
    var c = m.Replace,
        d = b(a, e);
    "production" !== "development" ? z("/" === n.pathname.charAt(0), "Relative pathnames are not supported in memory history.replace(" + JSON.stringify(a) + ")") : void 0;
    g(c, d, function () {
      w(a, e);
    }) && (h[f] = d, t(c, d));
  }
  ...
  var h = (void 0 === a ? ["/"] : a).map(function (a) {
    ...
    "production" !== "development" ? z("/" === b.pathname.charAt(0), "Relative pathnames are not supported in createMemoryHistory({ initialEntries }) (invalid entry: " + JSON.stringify(a) + ")") : void 0;
    return b;
  }),
...
},{"@babel/runtime/helpers/esm/extends":"../node_modules/@babel/runtime/helpers/esm/extends.js"}],"index.jsx":[function(require,module,exports) {
"use strict";
